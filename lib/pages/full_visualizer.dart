...
class FullVisualizer extends StatefulWidget {
  const FullVisualizer({Key? key}) : super(key: key);

  @override
  State<FullVisualizer> createState() => _FullVisualizerState();
}

class _FullVisualizerState extends State<FullVisualizer> {
  @override
  void initState() {
    super.initState();
  }
                      ...
                      child: Padding(
                        ...
                        child: SfCartesianChart(
                          ...
                          legend: Legend(
                            isVisible: true,
                            title:
                                LegendTitle(text: "emf reading of your device"),
                          ),
